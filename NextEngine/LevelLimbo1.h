...
class LevelLimbo1 : public Level
{
private:
	...
	InteractableObject* vergil;
	InteractableObject* bowStatue;
	InteractableObject* swordStatue;
	InteractableObject* shieldStatue;

	TexturedObject* bowStatue2;
	TexturedObject* swordStatue2;
	TexturedObject* shieldStatue2;
...
public:
	...
	void nextLevel() {
		...
		gameStateController->pendingLoad.nextStateAfterLoad = GameState::GS_LIMBO2;
