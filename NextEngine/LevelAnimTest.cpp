...
void LevelAnimTest::levelInit() {
	...
	obj->getAnimationComponent()->addState("down", 0, 4);
	obj->getAnimationComponent()->addState("left", 1, 4);
	obj->getAnimationComponent()->addState("right", 2, 4);
	obj->getAnimationComponent()->addState("up", 3, 4);
