...
Bow::Bow() {
	...
	BowUltimateCollider* attack1 = new BowUltimateCollider(50, 0, 6); //Change damage and ult gain percentage here
	...
	BowUltimateCollider* attack2 = new BowUltimateCollider(100, 0, 7.5f);
